...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/motionless-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13649&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/motionless-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `motionless` can be installed with:

```
conda install motionless
```

It is possible to list all of the versions of `motionless` available on your platform with:
